@props(['icon' => 'inbox', 'title' => 'Nenhum resultado', 'description' => ''])
...
$icons = [
    ...
    'badge' => 'M9 14l6-6m-5.5.5h.01m4.99 5h.01M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16l3.5-2 3.5 2 3.5-2 3.5 2z',
...
<div class="text-center py-16 px-4">
    ...
    @if($description)
        <p class="text-sm text-gray-400 dark:text-gray-500 mb-4 max-w-xs mx-auto">{{ $description }}</p>
    @endif
    @if($slot->isNotEmpty())
